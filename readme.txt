...
Tags: woocommerce, commerce, e-commerce, commerce, shop, virtual shop, rashapay bank, rashapay, iran, persian, farsi,woocommerce persian, e-commerce, ووکامرس, ووکامرس فارسی,rashapay woocommerce,بانک راشا پرداخت,درگاه پرداخت,payment gateway,rashapay,woocommerce payment
Requires at least: 4.0
Tested up to: 4.5

پرداخت اینترنتی وجه به وسیله درگاه پرداخت واسطه راشا پرداخت

== Description ==
**Woocommerce rashapay Gateway** این افزونه شما را قادر می سازد تا براحتی اقدام به ایجاد درگاه پرداخت اینترنتی راشا پرداخت برای پرداخت های محصولات ووکامرس کنید

= امکانات =
 * سازگار با ووکامرس 2.2 و بالاتر
 * پنل تنظیمات ساده و کاربرپسند
 * تنظیم پیام دلخواه در هنگام پرداخت موفقیت آمیز ، انصراف از پرداخت و یا لغو پرداخت
 * قابلیت نمایش کد رهگیری راشا پرداخت همراه با کد میانبر
...
== Installation ==
1. پوشه `rashapay-woocommerce` را در مسیر `/wp-content/plugins/` آپلود کنید
